package com.example.a2zserviceprovider.Painter;
...
public class PainterActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer = findViewById(R.id.drawer_layout_painter);
        navigationView = findViewById(R.id.nav_view_painter);
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container_painter, new PainterFragment()).commit();
        }
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_services:
                fetchTotalServicesBW bw = new fetchTotalServicesBW(this, "Painter");
                bw.execute();
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_painter);
